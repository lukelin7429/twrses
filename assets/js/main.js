...
(function () {
  ...
  /* 🔊 buttons — a recorded clip where we have one, the device voice otherwise.
     ...
     served from the twrses-say-audio R2 bucket; the manifest maps a phrase to
     its filename. The device voice is whatever the visitor's OS ships — fine on
     a Mac, poor on Windows, often absent on Android — so it is the fallback,
     not the default. Note this is only for words, example sentences and
     questions: the passages themselves are read by a human and play from their
     own <audio> players. */
  var SAY_BASE = 'https://pub-53f20fadeae54598a39a22eb35326575.r2.dev/';
